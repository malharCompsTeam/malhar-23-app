                    ...
                    children: [
                      Text("Open to: ",
                          style: GoogleFonts.ptSans(
                              ...
                              color: Color(0xff200020))),
                      if (i == 1)
                        Text("Contingents, PRNCs and OTSE",
                            style: GoogleFonts.ptSans(
                                fontWeight: FontWeight.w500,
                                fontSize: 16,
                                color: Color(0xff200020))),
                      if (i == 2)
                        Text("Contingents, PRNCs",
                            style: GoogleFonts.ptSans(
                                fontWeight: FontWeight.w500,
                                fontSize: 16,
                                color: Color(0xff200020)))
                    ...
                    children: [
                      Text("Type number: ",
                          style: GoogleFonts.ptSans(
                              ...
                              color: Color(0xff200020))),
                      if (i == 1)
                        Text("Group Event(6-10 per group)",
                            style: GoogleFonts.ptSans(
                                fontWeight: FontWeight.w500,
                                fontSize: 16,
                                color: Color(0xff200020))),
                      if (i == 2)
                        Text("Group Event(2-8 per group)",
                            style: GoogleFonts.ptSans(
                                fontWeight: FontWeight.w500,
                                fontSize: 16,
                                color: Color(0xff200020)))
                    ...
                    children: [
                      Text("Event Cap:",
                          style: GoogleFonts.ptSans(
                              ...
                              color: Color(0xff200020))),
                      if (i == 1)
                        Text("Eliminations: 20 entries, Finals: 12 entries",
                            style: GoogleFonts.ptSans(
                                fontWeight: FontWeight.w500,
                                fontSize: 16,
                                color: Color(0xff200020))),
              ...
              child: Column(
                children: [
                  ...
                  CircleAvatar(
                      radius: 50,
                      backgroundImage:
                          AssetImage("assets/icons/events_dept_icons/ipa.png")),
                  SizedBox(
                    height: 20,
                  ),
                  Text(
